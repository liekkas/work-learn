...
public class Imgshow {
    ...
    public Imgshow(String title, int height, int width) {
        SizeCustom = true;
        Height = height;
        Width = width;
    ...
    /**
     * Displays the given {@link Mat} in a new instance of {@link Imgshow}
     *
     * @param mat
    ...
    /**
     * Displays the given {@link Mat} in a new instance of {@link Imgshow} with
    ...
    /**
     * Displays the given {@link Mat} in a new instance of {@link Imgshow} with a
     * set size
     *
     * @param mat
     *            the {@link Mat} to display
