...
public class FaceDetection {
    ...
    public static void main(String[] args) {
        ...
        //照片源
        Mat image = Imgcodecs.imread(FaceDetection.class.getResource("/images/z.png").getPath());
        ...
        CascadeClassifier eyeCC = new CascadeClassifier(
                FaceDetection.class.getResource("/cascades/haarcascades_cuda/haarcascade_lefteye_2splits.xml").getPath());
        ...
        //输出成像结果
        String filename = "learn-opencv/opencv3/opencv3-out.png";
